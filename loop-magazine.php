...
if ( $query->have_posts() ) { $count = 0; $column_count_1 = 0; $column_count_2 = 0; $column_count_3 = 0;
?>
...
<?php
	while ( $query->have_posts() ) { $query->the_post(); $count++;
		...
		$column_count_1++; $column_count_2++; $column_count_3++;
?>
		<div class="threecol-one<?php if ( $column_count_1 > 2 ) { echo esc_attr( ' last' ); $column_count_1 = 0; } ?>">
		<?php
